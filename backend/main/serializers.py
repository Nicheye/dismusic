...
class AlbumSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Album
        fields = ['title', 'created_by', 'created_at', 'cover','tracks','url']
    ...
    def get_tracks(self,obj):
        ...
        tracks_ser = TrackSerializer(tracks_query,many=True,context=self.context)
...
class TrackSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Track
        fields = ['title','likes','dislikes','is_liked','is_disliked','streams','rec']
